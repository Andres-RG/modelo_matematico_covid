...
![Diagrama por compartimentos](04_Images/Diagrama%20por%20compartimentos.png)
...
+==========+=======================================================================================+===================+====================+
| $S_1$    | $- 0.3771 \frac{S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$   |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $E_1$    | $0.3771 \frac{S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$     | $-0.1785 E_1$     |                    |
+----------+----------------------------------------------------------------------------------------+-------------------+-------------------+
...
| \        |                                                                                       |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $S_2$    | $- 0.4473 \frac{S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$   |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $E_2$    | $0.4473 \frac{S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$     | $-0.1785 E_2$     |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
...
| \        |                                                                                       |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $S_3$    | $-0.5090 \frac{S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$    |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $E_3$    | $0.5090 \frac{S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$     | $-0.1785 E_3$     |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
...
| \        |                                                                                       |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $S_4$    | $- 0.5638 \frac{S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$   |                   |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
| $E_4$    | $0.5638 \frac{S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}$     | $-0.1785 E_4$     |                    |
+----------+---------------------------------------------------------------------------------------+-------------------+--------------------+
...
$$\begin{array}{l}
\text{Para el grupo 1 :} \\
\dot S_1 = - \beta_1 \frac{S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}  \\
\dot E_1 = \beta_1 \frac{S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N} - \alpha E_1 \\
...
\\
\text{Para el grupo 2 :} \\
\dot S_2 = - \beta_2 \frac{S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}  \\
\dot E_2 = \beta_2 \frac{S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N} - \alpha E_2 \\
...
\\
\text{Para el grupo 3 :} \\
\dot S_3 = - \beta_3 \frac{S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}  \\
\dot E_3 = \beta_3 \frac{S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N} - \alpha E_3 \\
...
\\
\text{Para el grupo 4 :} \\
\dot S_4 = - \beta_4 \frac{S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N}  \\
\dot E_4 = \beta_4 \frac{S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4})}{N} - \alpha E_4 \\
...
$$\begin{array}{l}
\dot N = - \beta_n \frac{S_n (\sum I_n + \sum I_{ln})}{N} + \\ 
\beta_n \frac{S_n (\sum I_n + \sum I_{ln})}{N} - \alpha E_n + \alpha E_n \\
