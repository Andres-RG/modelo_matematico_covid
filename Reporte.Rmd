...
![Heatmap bigmatrix](03_Out/Plots/bm_heatmap.jpeg)
...
![NMDS 1](03_Out/Plots/nmds1.jpeg)
...
$$\begin{array}{ll}
R_0 = \beta \, (\sum_{j=1}^{4} {\frac{\alpha \, \, p_{lj} \, \delta_l}{ \gamma_R } + \frac{\alpha \, p_{hj} \, \delta_h}{ \, (1-p_{ij}) \, \gamma_h)})}
\end{array}$$
...
![Incidencia COVID-19](03_Out/Plots/incidencia_covid_qro.jpeg)

![Estimación Rt](03_Out/Plots/r0_epiestim.jpeg)
