...
$$\begin{array}{l}
\text{Para el grupo 1 :} \\
\dot S_1 = - \frac{\beta_1}{N} S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) \\
\dot E_1 = \frac{\beta_1}{N} S_1 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) - \alpha E_1 \\
...
\\
\text{Para el grupo 2 :} \\
\dot S_2 = - \frac{\beta_2}{N} S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) \\
\dot E_2 = \frac{\beta_2}{N} S_2 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) - \alpha E_2 \\
...
\\
\text{Para el grupo 3 :} \\
\dot S_3 = - \frac{\beta_3}{N} S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) \\
\dot E_3 = \frac{\beta_3}{N} S_3 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) - \alpha E_3 \\
...
\\
\text{Para el grupo 4 :} \\
\dot S_4 = - \frac{\beta_4}{N} S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) \\
\dot E_4 = \frac{\beta_4}{N} S_4 (I_1 + I_2+ I_3 + I_4 + I_{l1} + I_{l2} + I_{l3} + I_{l4}) - \alpha E_4 \\
