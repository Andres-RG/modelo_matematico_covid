...
$$\begin{array}{l}
\text{Para el grupo 1 :} \\
\dot S_1 = - \beta_1 S_1 (I_1 + I_2+ I_3 + I_4)  \\
\dot E_1 = \beta_1 S_1 (I_1 + I_2+ I_3 + I_4) - \alpha E_1 \\
...
\\
\text{Para el grupo 2 :} \\
\dot S_2 = - \beta_2 S_2 (I_1 + I_2+ I_3 + I_4)\\
\dot E_2 = \beta_2 S_2 (I_1 + I_2+ I_3 + I_4) - \alpha E_2 \\
...
\\
\text{Para el grupo 3 :} \\
\dot S_3 = - \beta_3 S_3 (I_1 + I_2+ I_3 + I_4)  \\
\dot E_3 = \beta_3 S_3 (I_1 + I_2+ I_3 + I_4) - \alpha E_3 \\
...
\\
\text{Para el grupo 4 :} \\
\dot S_4 = - \beta_4 S_4 (I_1 + I_2+ I_3 + I_4)  \\
\dot E_4 = \beta_4 S_4 (I_1 + I_2+ I_3 + I_4) - \alpha E_4 \\
...
![Modelo matemático por estructura etaria para el estado de Querétaro](03_Out/Plots/Modelo COVID con Estructura Etaria para el Estado de Queretaro.png)
...
![Modelo covid grupo 1](03_Out/Plots/Modelo COVID del Grupo 1 para el Estado de Queretaro.png)

## 6.3 Modelo para el grupo etario 2
...
![Modelo covid para el grupo 2](03_Out/Plots/Modelo COVID del Grupo 2 para el Estado de Queretaro.png)

## 6.4 Modelo para el grupo etario 3
...
![Modelo covid para el grupo 3](03_Out/Plots/Modelo COVID del Grupo 3 para el Estado de Queretaro.png)

## 6.5 Modelo para el grupo etario 4
...
![Modelo covid para el grupo 4](03_Out/Plots/Modelo COVID del Grupo 4 para el Estado de Queretaro.png)