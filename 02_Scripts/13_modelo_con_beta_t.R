...
modelo_covid_beta_t <- function(t, state, parameters){
  ...
  with(as.list(c(state, parameters)), {
    ...
    ## GRUPO 1
    dS1   <- - (beta_interpol(t)/(N1+N2+N3+N4)) * S1 * (I1 + I2 + I3 + I4)
    dE1   <- ( (beta_interpol(t)/(N1+N2+N3+N4)) * S1 * (I1 + I2 + I3 + I4) ) - ( alpha * E1 )
    ...
    ## GRUPO 2
    dS2   <- - (beta_interpol(t)/(N1+N2+N3+N4)) * S2 * (I1 + I2 + I3 + I4)
    dE2   <- ( (beta_interpol(t)/(N1+N2+N3+N4)) * S2 * (I1 + I2 + I3 + I4) ) - ( alpha * E2 )
    ...
    ## GRUPO 3
    dS3   <- - (beta_interpol(t)/(N1+N2+N3+N4)) * S3 * (I1 + I2 + I3 + I4)
    dE3   <- ( (beta_interpol(t)/(N1+N2+N3+N4)) * S3 * (I1 + I2 + I3 + I4) ) - ( alpha * E3 )
    ...
    ## GRUPO 4
    dS4   <- - (beta_interpol(t)/(N1+N2+N3+N4)) * S4 * (I1 + I2 + I3 + I4)
    dE4   <- ( (beta_interpol(t)/(N1+N2+N3+N4)) * S4 * (I1 + I2 + I3 + I4) ) - ( alpha * E4 )
