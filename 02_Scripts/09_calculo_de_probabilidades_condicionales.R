...
casos_pos_re_comorbilidad_cat_1 <- filter(casos_pos_re_comorbilidad, 
                                          rango_de_edad == "18-")
comorbilidades_casos_1 <- casos_pos_re_comorbilidad_cat_1[,c(5:13)]
...
comorbilidades_casos_2 <- casos_pos_re_comorbilidad_cat_2[,c(5:13)]
...
comorbilidades_casos_3 <- casos_pos_re_comorbilidad_cat_3[,c(5:13)]
...
comorbilidades_casos_4 <- casos_pos_re_comorbilidad_cat_4[,c(5:13)]
