...
covid <- function(t, state, parameters){
  with(as.list(c(state, parameters)), {
    ## GRUPO 1
    dS1   <- - ( beta_1 / N ) * S1 * (I1 + I2 + I3 + I4)
    dE1   <- ( ( beta_1 / N ) * S1 * (I1 + I2 + I3 + I4) ) - ( alpha * E1 )
    ...
    ## GRUPO 2
    dS2   <- - ( beta_2 / N ) * S2 * (I1 + I2 + I3 + I4)
    dI2   <- ( ( beta_2 / N ) * S2 * (I1 + I2 + I3 + I4) ) - ( alpha * E2 )
    ...
    ## GRUPO 3
    dS3   <- - ( beta_3 / N ) * S3 * (I1 + I2 + I3 + I4)
    dE3   <- ( ( beta_3 / N ) * S3 * (I1 + I2 + I3 + I4) ) - ( alpha * E3 )
    ...
    ## GRUPO 4
    dS4   <- - ( beta_4 / N ) * S4 * (I1 + I2 + I3 + I4)
    dE4   <- ( ( beta_4 / N ) * S4 * (I1 + I2 + I3 + I4) ) - ( alpha * E4 )
