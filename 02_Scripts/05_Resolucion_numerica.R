...
modelo_covid <- function(t, state, parameters){
  with(as.list(c(state, parameters)), {
    ...
    ## GRUPO 1
    dS1   <- - (S1 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta) + (omega * R1)
    dE1   <- ( (S1 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta) ) - ( alpha * E1 )
    ...
    ## GRUPO 2
    dS2   <- - (S2 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta) + (omega * R2)
    dE2   <- ( S2 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta ) - ( alpha * E2 )
    ...
    ## GRUPO 3
    dS3   <- - (S3 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta) + (omega * R3)
    dE3   <- ( S3 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta ) - ( alpha * E3 )
    ...
    ## GRUPO 4
    dS4   <- - (S4 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta) + (omega * R4)
    dE4   <- ( S4 * (I1 + I2 + I3 + I4)/(N1 + N2 + N3 + N4) * beta ) - ( alpha * E4 )
...
# jpeg("03_Out/Plots/Modelo COVID con Estructura Etaria para el Estado de Queretaro.jpeg",
