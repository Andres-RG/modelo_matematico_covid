...
## Out ====
out_grupo_2 <- as.data.frame(ode(y     = state,
                                 times = t,
...
matplot(out_grupo_2[,1], out_grupo_2[,2:9], type ="l", xlab = "tiempo", ylab = "Población", 
...
#png("03_Out/Plots/Modelo COVID del Grupo 2 para el Estado de Queretaro.png",
